...
const menuItems = [
  ...
  { icon: ClipboardCheck, label: "受付", path: "/reception" },
  { icon: FileSpreadsheet, label: "取引入力", path: "/transactions" },
  { icon: Calculator, label: "締め処理", path: "/closing" },
  { icon: FileText, label: "精算書", path: "/settlements" },
